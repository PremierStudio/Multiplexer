...
impl ThemeTokens {
    /// Product dark: cool zinc page. Accent is blue and must stay off chrome.
    pub fn dark() -> Self {
    ...
    fn from_mode(mode: ThemeMode, density: Density) -> Self {
        let mut t = match mode {
            ThemeMode::Dark => Self {
                mode,
                density,
                bg: HslaTuple::new(0.67, 0.03, 0.055, 1.0),
                surface: HslaTuple::new(0.67, 0.03, 0.085, 1.0),
                surface_raised: HslaTuple::new(0.67, 0.03, 0.12, 1.0),
                glass: HslaTuple::new(0.67, 0.03, 0.085, 1.0),
                glass_strong: HslaTuple::new(0.67, 0.03, 0.055, 1.0),
                glass_ultra: HslaTuple::new(0.67, 0.03, 0.14, 0.40),
                ink: HslaTuple::new(0.67, 0.03, 0.055, 1.0),
                text: HslaTuple::new(0.67, 0.015, 0.93, 1.0),
                text_muted: HslaTuple::new(0.67, 0.02, 0.58, 1.0),
                text_faint: HslaTuple::new(0.67, 0.02, 0.40, 1.0),
                accent: HslaTuple::new(0.61, 0.70, 0.62, 1.0),
                accent_muted: HslaTuple::new(0.61, 0.18, 0.18, 1.0),
                good: HslaTuple::new(0.38, 0.40, 0.52, 1.0),
                warn: HslaTuple::new(0.10, 0.55, 0.55, 1.0),
                danger: HslaTuple::new(0.01, 0.62, 0.56, 1.0),
                hairline: HslaTuple::new(0.67, 0.03, 0.13, 1.0),
                hairline_bright: HslaTuple::new(0.67, 0.03, 0.20, 1.0),
                selection: HslaTuple::new(0.67, 0.04, 0.16, 1.0),
                focus_ring: HslaTuple::new(0.61, 0.70, 0.62, 1.0),
                space_1: 0.0,
                space_2: 0.0,
                space_3: 0.0,
                space_4: 0.0,
            ...
            ThemeMode::Light => Self {
                mode,
                density,
                bg: HslaTuple::new(0.67, 0.04, 0.97, 1.0),
                surface: HslaTuple::new(0.67, 0.02, 0.99, 1.0),
                surface_raised: HslaTuple::new(0.0, 0.0, 1.0, 1.0),
                glass: HslaTuple::new(0.67, 0.02, 0.99, 1.0),
                glass_strong: HslaTuple::new(0.67, 0.04, 0.97, 1.0),
                glass_ultra: HslaTuple::new(0.67, 0.04, 0.94, 0.70),
                ink: HslaTuple::new(0.67, 0.04, 0.97, 1.0),
                text: HslaTuple::new(0.67, 0.04, 0.10, 1.0),
                text_muted: HslaTuple::new(0.67, 0.03, 0.36, 1.0),
                text_faint: HslaTuple::new(0.67, 0.02, 0.48, 1.0),
                accent: HslaTuple::new(0.61, 0.72, 0.46, 1.0),
                accent_muted: HslaTuple::new(0.61, 0.20, 0.92, 1.0),
                good: HslaTuple::new(0.38, 0.42, 0.36, 1.0),
                warn: HslaTuple::new(0.10, 0.60, 0.42, 1.0),
                danger: HslaTuple::new(0.01, 0.65, 0.42, 1.0),
                hairline: HslaTuple::new(0.67, 0.04, 0.86, 1.0),
                hairline_bright: HslaTuple::new(0.67, 0.04, 0.78, 1.0),
                selection: HslaTuple::new(0.67, 0.04, 0.92, 1.0),
                focus_ring: HslaTuple::new(0.61, 0.72, 0.46, 1.0),
                space_1: 0.0,
                space_2: 0.0,
                space_3: 0.0,
                space_4: 0.0,
