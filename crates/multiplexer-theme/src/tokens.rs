    ...
    fn from_mode(mode: ThemeMode, density: Density) -> Self {
        let mut t = match mode {
            ThemeMode::Dark => Self {
                mode,
                density,
                bg: HslaTuple::new(0.67, 0.04, 0.07, 1.0),
                surface: HslaTuple::new(0.67, 0.03, 0.10, 1.0),
                surface_raised: HslaTuple::new(0.67, 0.03, 0.13, 1.0),
                glass: HslaTuple::new(0.67, 0.03, 0.10, 1.0),
                glass_strong: HslaTuple::new(0.67, 0.04, 0.07, 1.0),
                glass_ultra: HslaTuple::new(0.67, 0.03, 0.14, 0.40),
                ink: HslaTuple::new(0.67, 0.04, 0.07, 1.0),
                text: HslaTuple::new(0.67, 0.02, 0.90, 1.0),
                text_muted: HslaTuple::new(0.67, 0.03, 0.56, 1.0),
                ...
                hairline: HslaTuple::new(0.67, 0.03, 0.16, 1.0),
                hairline_bright: HslaTuple::new(0.67, 0.03, 0.22, 1.0),
                selection: HslaTuple::new(0.67, 0.04, 0.15, 1.0),
